...
print("La cantidad de los insufientes es", contInsuficiente)
print("La cantidad de los aceptables es", contAceptable)
print("La cantidad de los sobresalientes es", contSobresaliente)

print("El promedio de los insufientes es", sumaInsuficiente/contInsuficiente)
...
print("La suma de los insufientes es", sumaInsuficiente)
