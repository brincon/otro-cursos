# determinar la suma de los elementos en la diagonal principal que sean
# mayores a 20
# determinar el producto de los datos negativos en la diagonal inversa.
# sacar la suma de ambos valores
